        ...
        <div className="">
          ...
          {data?.map(loyaltyData => (
            <div key={loyaltyData.program_id} className="flex items-center border border-gray-300 p-2 space-x-2 bg-white rounded-md shadow-md">
              <input className='w-[50px] overflow-x-auto' defaultValue={loyaltyData.program_id} />
              <input className='w-[200px] overflow-x-auto' defaultValue={loyaltyData.name} type='text' onChange={(e)=>setName(e.target.value)}/>
              <input className='w-[300px] overflow-x-auto' defaultValue={loyaltyData.description} type='text' onChange={(e)=>setDescription(e.target.value)}/>
              <input className='w-[150px] overflow-x-auto text-center' defaultValue={loyaltyData.points_per_dollar} type='number' onChange={(e)=>setPointsperdollar(e.target.value)}/>
